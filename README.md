Prostate cancer is one of the most prevalent forms of cancer among males globally. In 2020, it resulted in the death of over 1.4 million people. Despite the fact that localized prostate cancer is treatable, the early detection of small or low-volume lesions is difficult. The use of image-based techniques is vital in the diagnosis, staging, and treatment of prostate cancer. However, each technique is limited by physical constraints such as spatial resolution, the image's ability to show an object's location. 
